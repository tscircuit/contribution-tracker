...
export class CachedOctokit {
  ...
  public pulls = {
    list: async (
    ...
    ): Promise<{ data: Endpoints["GET /repos/{owner}/{repo}/pulls"]["response"]["data"] }> => {
      ...
      await this.setCached("pulls.list", params as Record<string, unknown>, response.data)
      return response
    },
    ...
    get: async (
      ...
      await this.setCached("pulls.get", params as Record<string, unknown>, response.data)
      return response
    },
  }
  ...
  public issues = {
    ...
    ): Promise<{ data: Endpoints["GET /repos/{owner}/{repo}/issues"]["response"]["data"] }> => {
      const cached = await this.getCached<
  ...
  public repos = {
    ...
    ): Promise<{ data: Endpoints["GET /orgs/{org}/repos"]["response"]["data"] }> => {
      const cached = await this.getCached<
