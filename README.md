...
pie
    ...
    "tscircuit/svg.tscircuit.com" : 33
...
|---|---|---|---|---|---|---|---|---|
| [ArnavK-09](#ArnavK-09) | 11 | 8 | 1 | 2 | 1 | 21 | 18 | 0 |
| [seveibar](#seveibar) | 15 | 0 | 0 | 51 | 14 | 50 | 40 | 0 |
| [Simplereally](#Simplereally) | 0 | 0 | 0 | 0 | 0 | 2 | 0 | 0 |
| [Abse2001](#Abse2001) | 15 | 15 | 0 | 3 | 1 | 16 | 15 | 0 |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 11 | 9 | 0 | 12 | 0 | 12 | 9 | 0 |
| [tscircuitbot](#tscircuitbot) | 1 | 0 | 0 | 0 | 0 | 370 | 321 | 0 |
| [imrishabh18](#imrishabh18) | 4 | 4 | 0 | 7 | 2 | 18 | 17 | 0 |
| [ainanasolo2005-commits](#ainanasolo2005-commits) | 1 | 0 | 0 | 0 | 0 | 1 | 0 | 0 |
| [rushabhcodes](#rushabhcodes) | 38 | 16 | 3 | 1 | 1 | 13 | 11 | 0 |
| [techmannih](#techmannih) | 21 | 13 | 4 | 7 | 2 | 21 | 12 | 0 |
| [shehaban](#shehaban) | 12 | 3 | 6 | 0 | 0 | 4 | 1 | 0 |
| [nailoo](#nailoo) | 5 | 4 | 0 | 1 | 0 | 3 | 3 | 0 |
| [MustafaMulla29](#MustafaMulla29) | 10 | 2 | 3 | 0 | 0 | 6 | 2 | 0 |
| [Heinrich-XIAO](#Heinrich-XIAO) | 3 | 2 | 0 | 0 | 0 | 2 | 2 | 0 |
| [Ayushjhawar8](#Ayushjhawar8) | 5 | 1 | 0 | 0 | 0 | 2 | 1 | 0 |
| [bimakw](#bimakw) | 2 | 0 | 1 | 0 | 0 | 5 | 0 | 0 |
...
|------|--------|-------------|-------------|
| [#2639](https://github.com/tscircuit/tscircuit.com/pull/2639) | 🐌 Tiny | ArnavK-09 | Fixes the KiCad PCM URL link rendering in the sidebar and introduces a new component for the KiCad PCM URL. |
...
| [#2635](https://github.com/tscircuit/tscircuit.com/pull/2635) | 🐌 Tiny | tscircuitbot | Updates the version of the tscircuiteval package from 0.0.618 to 0.0.619 in package.json |
...
| [#2638](https://github.com/tscircuit/tscircuit.com/pull/2638) | 🐌 Tiny | imrishabh18 | Removes the useComponent hook from sample board templates and replaces it with direct component imports. |
...
| [#1887](https://github.com/tscircuit/cli/pull/1887) | 🐙 Minor | ⭐⭐ | imrishabh18 | Fixes an error where the build process attempts to create a directory at the root of the filesystem when package.json is not found, instead it now uses the current working directory as a fallback. |
...
| [#1890](https://github.com/tscircuit/cli/pull/1890) | 🐌 Tiny | tscircuitbot | Updates the package version from v0.1.871 to v0.1.872 in package.json |
| [#1889](https://github.com/tscircuit/cli/pull/1889) | 🐌 Tiny | tscircuitbot | Updates the tscircuitrunframe package to version 0.0.1566 in the package.json file. |
| [#1888](https://github.com/tscircuit/cli/pull/1888) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1886](https://github.com/tscircuit/cli/pull/1886) | 🐌 Tiny | tscircuitbot | Updates the package version from 0.1.869 to 0.1.870 in package.json |
| [#1885](https://github.com/tscircuit/cli/pull/1885) | 🐌 Tiny | tscircuitbot | Updates the tscircuitrunframe package from version 0.0.1564 to 0.0.1565 |
| [#1884](https://github.com/tscircuit/cli/pull/1884) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1883](https://github.com/tscircuit/cli/pull/1883) | 🐌 Tiny | tscircuitbot | Updates the package version from v0.1.867 to v0.1.868 in package.json |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#110](https://github.com/tscircuit/circuit-json-to-kicad/pull/110) | 🐳 Major | ⭐⭐⭐ | seveibar | Adds support for four-layer PCBs by implementing layer mapping and updating PCB initialization to accommodate additional copper layers. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#670](https://github.com/tscircuit/3d-viewer/pull/670) | 🐳 Major | ⭐⭐⭐ | Heinrich-XIAO | Fixes the issue where components on the bottom layer are flipped incorrectly due to double rotation. |
...
| [#2090](https://github.com/tscircuit/tscircuit/pull/2090) | 🐌 Tiny | tscircuitbot | Updates the tscircuitcli package to version 0.1.872 and the tscircuitrunframe package to version 0.0.1566 in package.json |
| [#2089](https://github.com/tscircuit/tscircuit/pull/2089) | 🐌 Tiny | tscircuitbot | Updates the package version from 0.0.1254 to 0.0.1255 in package.json |
| [#2088](https://github.com/tscircuit/tscircuit/pull/2088) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#2087](https://github.com/tscircuit/tscircuit/pull/2087) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#2085](https://github.com/tscircuit/tscircuit/pull/2085) | 🐌 Tiny | tscircuitbot | Updates the package version from 0.0.1252 to 0.0.1253 in package.json |
| [#2084](https://github.com/tscircuit/tscircuit/pull/2084) | 🐌 Tiny | tscircuitbot | Updates the tscircuitcli package from version 0.1.866 to 0.1.867 and the tscircuitrunframe package from version 0.0.1561 to 0.0.1563 in package.json |
...
| [#1969](https://github.com/tscircuit/eval/pull/1969) | 🐌 Tiny | tscircuitbot | Automated package update |
...
|------|--------|-------------|
| [#2639](https://github.com/tscircuit/tscircuit.com/pull/2639) | 🐌 Tiny | Fixes the KiCad PCM URL link rendering in the sidebar and introduces a new component for the KiCad PCM URL. |
...
| [#110](https://github.com/tscircuit/circuit-json-to-kicad/pull/110) | 🐳 Major | ⭐⭐⭐ | Adds support for four-layer PCBs by implementing layer mapping and updating PCB initialization to accommodate additional copper layers. |
...
<details>
<summary>🐌 Tiny Contributions (321)</summary>
...
| [#2090](https://github.com/tscircuit/tscircuit/pull/2090) | 🐌 Tiny | Updates the tscircuitcli package to version 0.1.872 and the tscircuitrunframe package to version 0.0.1566 in package.json |
| [#2089](https://github.com/tscircuit/tscircuit/pull/2089) | 🐌 Tiny | Updates the package version from 0.0.1254 to 0.0.1255 in package.json |
| [#2088](https://github.com/tscircuit/tscircuit/pull/2088) | 🐌 Tiny | Automated package update |
| [#2087](https://github.com/tscircuit/tscircuit/pull/2087) | 🐌 Tiny | Automated package update |
| [#2085](https://github.com/tscircuit/tscircuit/pull/2085) | 🐌 Tiny | Updates the package version from 0.0.1252 to 0.0.1253 in package.json |
| [#2084](https://github.com/tscircuit/tscircuit/pull/2084) | 🐌 Tiny | Updates the tscircuitcli package from version 0.1.866 to 0.1.867 and the tscircuitrunframe package from version 0.0.1561 to 0.0.1563 in package.json |
...
| [#2635](https://github.com/tscircuit/tscircuit.com/pull/2635) | 🐌 Tiny | Updates the version of the tscircuiteval package from 0.0.618 to 0.0.619 in package.json |
...
| [#1969](https://github.com/tscircuit/eval/pull/1969) | 🐌 Tiny | Automated package update |
...
| [#1890](https://github.com/tscircuit/cli/pull/1890) | 🐌 Tiny | Updates the package version from v0.1.871 to v0.1.872 in package.json |
| [#1889](https://github.com/tscircuit/cli/pull/1889) | 🐌 Tiny | Updates the tscircuitrunframe package to version 0.0.1566 in the package.json file. |
| [#1888](https://github.com/tscircuit/cli/pull/1888) | 🐌 Tiny | Automated package update |
| [#1886](https://github.com/tscircuit/cli/pull/1886) | 🐌 Tiny | Updates the package version from 0.1.869 to 0.1.870 in package.json |
| [#1885](https://github.com/tscircuit/cli/pull/1885) | 🐌 Tiny | Updates the tscircuitrunframe package from version 0.0.1564 to 0.0.1565 |
| [#1884](https://github.com/tscircuit/cli/pull/1884) | 🐌 Tiny | Automated package update |
| [#1883](https://github.com/tscircuit/cli/pull/1883) | 🐌 Tiny | Updates the package version from v0.1.867 to v0.1.868 in package.json |
...
| [#1887](https://github.com/tscircuit/cli/pull/1887) | 🐙 Minor | ⭐⭐ | Fixes an error where the build process attempts to create a directory at the root of the filesystem when package.json is not found, instead it now uses the current working directory as a fallback. |
...
| [#2638](https://github.com/tscircuit/tscircuit.com/pull/2638) | 🐌 Tiny | Removes the useComponent hook from sample board templates and replaces it with direct component imports. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#670](https://github.com/tscircuit/3d-viewer/pull/670) | 🐳 Major | ⭐⭐⭐ | Fixes the issue where components on the bottom layer are flipped incorrectly due to double rotation. |
