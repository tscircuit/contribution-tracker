...
| [seveibar](#seveibar) | 7 | 0 | 0 | 21 | 0 | 18 | 14 | 0 | 0 | 0 |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 1 | 1 | 0 | 5 | 0 | 1 | 1 | 0 | 0 | 0 |
| [Abse2001](#Abse2001) | 9 | 7 | 0 | 10 | 0 | 8 | 7 | 0 | 0 | 0 |
...
| [ArnavK-09](#ArnavK-09) | 11 | 8 | 0 | 0 | 0 | 13 | 7 | 0 | 0 | 0 |
...
| [#95](https://github.com/tscircuit/schematic-corpus/pull/95) | 🐙 Minor | ⭐⭐ | Abse2001 | This PR adds a GitHub star button and a mobile-friendly burger menu to the site, enhancing user interaction and accessibility on mobile devices. |
...
| [#100](https://github.com/tscircuit/schematic-corpus/pull/100) | 🐌 Tiny | MustafaMulla29 | Adds a new design component (design065) to enhance the autorouting algorithm by providing a new circuit board layout. |
...
| [#89](https://github.com/tscircuit/schematic-corpus/pull/89) | 🐌 Tiny | MustafaMulla29 | Adds a new circuit design (design60) to enhance the autorouting algorithm by introducing a new schematic representation. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#1077](https://github.com/tscircuit/core/pull/1077) | 🐙 Minor | ⭐⭐ | techmannih | Fixes pin aliases for transistors to use standard labels (collector, emitter, base) in connections. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#281](https://github.com/tscircuit/cli/pull/281) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Introduce image-based visual diffing for more reliable snapshot verification in the snapshot generation process, allowing for better detection of visual changes in circuit board representations. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#47](https://github.com/tscircuit/simple-3d-svg/pull/47) | 🐌 Tiny | seveibar | Transforms STL model coordinates from Z-up to Y-up by rotating vertices and normals, ensuring compatibility with Y-up systems. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#5](https://github.com/tscircuit/circuit-json-to-spice/pull/5) | 🐌 Tiny | seveibar | Adds integration tests for the EEcircuit-engine, including a new bunfig.toml configuration and updates to package dependencies. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#1491](https://github.com/tscircuit/tscircuit.com/pull/1491) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Hides the file delete option in the FileSidebar component for users who do not own the package, ensuring that only the owner can delete files. |
...
| [#1475](https://github.com/tscircuit/tscircuit.com/pull/1475) | 🐙 Minor | ⭐⭐ | ArnavK-09 | Replaces plain text loading indicator with animated placeholders in the ShikiCodeViewer component to improve user experience during loading states. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#7](https://github.com/tscircuit/led-water-accelerometer/pull/7) | 🐌 Tiny | imrishabh18 | Adds firmware to control a NeoPixel LED matrix for displaying animated text and patterns, specifically for the tscircuit logo. |
...
| [#100](https://github.com/tscircuit/schematic-corpus/pull/100) | 🐌 Tiny | Adds a new design component (design065) to enhance the autorouting algorithm by providing a new circuit board layout. |
...
| [#89](https://github.com/tscircuit/schematic-corpus/pull/89) | 🐌 Tiny | Adds a new circuit design (design60) to enhance the autorouting algorithm by introducing a new schematic representation. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#281](https://github.com/tscircuit/cli/pull/281) | 🐳 Major | ⭐⭐⭐ | Introduce image-based visual diffing for more reliable snapshot verification in the snapshot generation process, allowing for better detection of visual changes in circuit board representations. |
...
| [#95](https://github.com/tscircuit/schematic-corpus/pull/95) | 🐙 Minor | ⭐⭐ | This PR adds a GitHub star button and a mobile-friendly burger menu to the site, enhancing user interaction and accessibility on mobile devices. |
...
| [#5](https://github.com/tscircuit/circuit-json-to-spice/pull/5) | 🐌 Tiny | Adds integration tests for the EEcircuit-engine, including a new bunfig.toml configuration and updates to package dependencies. |
...
| [#47](https://github.com/tscircuit/simple-3d-svg/pull/47) | 🐌 Tiny | Transforms STL model coordinates from Z-up to Y-up by rotating vertices and normals, ensuring compatibility with Y-up systems. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#1077](https://github.com/tscircuit/core/pull/1077) | 🐙 Minor | ⭐⭐ | Fixes pin aliases for transistors to use standard labels (collector, emitter, base) in connections. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#1491](https://github.com/tscircuit/tscircuit.com/pull/1491) | 🐳 Major | ⭐⭐⭐ | Hides the file delete option in the FileSidebar component for users who do not own the package, ensuring that only the owner can delete files. |
...
| PR # | Impact | Description |
|------|--------|-------------|
| [#7](https://github.com/tscircuit/led-water-accelerometer/pull/7) | 🐌 Tiny | Adds firmware to control a NeoPixel LED matrix for displaying animated text and patterns, specifically for the tscircuit logo. |
...
| [#1475](https://github.com/tscircuit/tscircuit.com/pull/1475) | 🐙 Minor | ⭐⭐ | Replaces plain text loading indicator with animated placeholders in the ShikiCodeViewer component to improve user experience during loading states. |
