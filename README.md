...
| [#765](https://github.com/tscircuit/core/pull/765) | 🟣 | seveibar | Allow passing platform configuration into RootCircuit | ✅ |
...
| [#986](https://github.com/tscircuit/tscircuit.com/pull/986) | 🐙 Minor | imrishabh18 | Removes the `jlc-parts-engine` module. | ❌ |
...
| [#979](https://github.com/tscircuit/tscircuit.com/pull/979) | 🐙 Minor | ShiboSoftwareDev | Fixed a regression in the behavior of the ctrl/cmd prompt in the code editor. | ✅ |
| [#977](https://github.com/tscircuit/tscircuit.com/pull/977) | 🐙 Minor | mohan-bee | Added a copy to clipboard option for code blocks in the readme. | ❌ |
...
| [#18](https://github.com/tscircuit/chat.tscircuit.com/pull/18) | 🐳 Major | Remove next-auth with custom auth handling | ❌ |
| [#1](https://github.com/tscircuit/parts-engine/pull/1) | 🐳 Major | Transfer the jlcPartsEngine from `tscircuit.com` to this module | ❌ |
...
| [#986](https://github.com/tscircuit/tscircuit.com/pull/986) | 🐙 Minor | Removes the `jlc-parts-engine` module. | ❌ |
...
| [#249](https://github.com/tscircuit/eval/pull/249) | 🐙 Minor | Adds a test to verify that the parts engine works as expected. | ✅ |
...
| [#4](https://github.com/tscircuit/chat.tscircuit.com/pull/4) | 🐙 Minor | Fixed the zoomed-in view in the mobile view of the home screen. | ❌ |
...
| [#765](https://github.com/tscircuit/core/pull/765) | 🟣 | Allow passing platform configuration into RootCircuit | ✅ |
...
| [#248](https://github.com/tscircuit/eval/pull/248) | 🐙 Minor | Adds a platform configuration mechanism via the `RootCircuit` constructor. | ✅ |
