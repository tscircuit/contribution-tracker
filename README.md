...
|-------------|---------|---------|---------|-------|-----|
| [seveibar](#seveibar) | 86 | 62 | 49 | 482 | 👑👑👑 |
| [mohan-bee](#mohan-bee) | 8 | 8 | 8 | 62 | ⭐⭐⭐ |
| [rushabhcodes](#rushabhcodes) | 6 | 7 | 12 | 53 | ⭐⭐⭐ |
| [MustafaMulla29](#MustafaMulla29) | 6 | 2 | 15 | 41 | ⭐⭐ |
| [0hmX](#0hmX) | 7 | 2 | 7 | 40 | ⭐⭐ |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 7 | 0 | 2 | 35 | ⭐⭐ |
| [Abse2001](#Abse2001) | 3 | 3 | 6 | 26 | ⭐⭐ |
| [imrishabh18](#imrishabh18) | 2 | 3 | 7 | 22 | ⭐⭐ |
| [techmannih](#techmannih) | 1 | 3 | 9 | 19.5 | ⭐⭐ |
| [AnasSarkiz](#AnasSarkiz) | 2 | 2 | 4 | 19 | ⭐⭐ |
| [tscircuitbot](#tscircuitbot) | 0 | 0 | 416 | 16.5 | ⭐⭐ |
| [anil08607](#anil08607) | 0 | 3 | 5 | 11 | ⭐⭐ |
...
| [anil08607](#anil08607) | 4 | 1 | 3 | 75.0% |
...
| [astrimid](#astrimid) | 3 | 0 | 3 | 100.0% |
| [GokulPandi-M](#GokulPandi-M) | 3 | 2 | 1 | 33.3% |
...
- [#760](https://github.com/tscircuit/footprinter/pull/760) fix(bga): use circular pads by default for KiCad parity
...
<details>
<summary>astrimid SPR PRs (3)</summary>
...
- [#4205](https://github.com/tscircuit/runframe/pull/4205) Bun install proper deps
...
- [#2904](https://github.com/tscircuit/core/pull/2904) Fix fuse sch show ratings
...
| [AnasSarkiz](#AnasSarkiz) | 10 | 9 | 0 | 3 | 0 | 24 | 10 | 0 |
| [anil08607](#anil08607) | 23 | 15 | 2 | 0 | 0 | 13 | 9 | 0 |
...
| [imrishabh18](#imrishabh18) | 4 | 2 | 0 | 11 | 3 | 17 | 15 | 0 |
...
| [KrishnaX12](#KrishnaX12) | 10 | 3 | 5 | 0 | 0 | 9 | 2 | 0 |
| [minerva32](#minerva32) | 0 | 0 | 0 | 0 | 0 | 1 | 0 | 0 |
| [mohan-bee](#mohan-bee) | 27 | 18 | 2 | 6 | 2 | 34 | 26 | 0 |
...
| [seveibar](#seveibar) | 36 | 3 | 0 | 80 | 13 | 249 | 204 | 0 |
| [Shahinn0x](#Shahinn0x) | 1 | 0 | 0 | 0 | 0 | 1 | 0 | 0 |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 8 | 8 | 0 | 5 | 0 | 107 | 11 | 0 |
...
| [#2994](https://github.com/tscircuit/core/pull/2994) | 🐳 Major | ⭐⭐⭐ | seveibar | Disables legacy autorouters by default, requiring explicit opt-in for legacy behavior and migrating tests to the default autorouter. |
| [#2992](https://github.com/tscircuit/core/pull/2992) | 🐳 Major | ⭐⭐⭐ | seveibar | Prevents autorouting from starting when placement checks fail or when trace lengths exceed maximum limits, ensuring more reliable PCB designs. |
...
| [#2999](https://github.com/tscircuit/core/pull/2999) | 🐙 Minor | ⭐⭐ | seveibar | Emit resolved DDR routing constraints including bus maxLengthSkew, traceWidth, allowedLayers, and differential-pair traceGap and maxUncoupledLength through existing adapters, while maintaining existing design compatibility. |
| [#2990](https://github.com/tscircuit/core/pull/2990) | 🐙 Minor | ⭐⭐ | seveibar | Fixes incorrect assembly orientations by storing the normalized, accumulated PCB transform rotation for components within rotated groups. |
| [#2980](https://github.com/tscircuit/core/pull/2980) | 🐙 Minor | ⭐⭐ | seveibar | Preserves literal pcb_silkscreen_text.text values generated by the explicit silkscreenlabel(...) footprinter option when importing a footprinter result into core, allowing custom text to remain unchanged while resolving reference placeholders to the component name. |
...
| [#2963](https://github.com/tscircuit/core/pull/2963) | 🐙 Minor | ⭐⭐ | anil08607 | Adds support for fabrication note text rotation in Circuit JSON, ensuring correct orientation when rendered or reconstructed. |
...
| [#2986](https://github.com/tscircuit/core/pull/2986) | 🐌 Tiny | tscircuitbot | Updates the package version of tscircuitinfer-cable-insertion-point from 0.0.2 to 0.0.3 in package.json |
...
| [#2972](https://github.com/tscircuit/core/pull/2972) | 🐌 Tiny | tscircuitbot | Updates the tscircuitchecks package from version 0.0.147 to 0.0.148 |
...
| [#7](https://github.com/tscircuit/header-modules/pull/7) | 🐳 Major | ⭐⭐⭐ | seveibar | Promotes the remaining 280 catalog components from generated definitions to dedicated idiomatic TSX files. Each module now has an explicit chip , concrete pinLabelspinAttributes, a unique bordered and labeled female headermodule footprint, and a dedicated PCB  schematic snapshot test. Also removes the component blocks from generatedModules.tsx, exports every module directly from index.ts, and updates the catalog documentation to reflect that all 427 entries are implemented as dedicated modules. Validation: bun run typecheck bun test (438 tests, 0 failures) bun run build bun run snapshot npx tsci check schematic-placement unique-footprint and complete-pin-metadata audit git diff --check |
...
| [#4177](https://github.com/tscircuit/tscircuit.com/pull/4177) | 🐳 Major | ⭐⭐⭐ | rushabhcodes | Replaces the CodeMirror-based CodeEditor in CodeAndPreview with WorkspaceCodeEditor from tscircuitmonaco-code-editor (v0.0.22), bringing the workspace UI (file sidebar, breadcrumb symbol navigation, quick-open, cross-file search) to the web editor and implements a mobile memory toggle to prevent out-of-memory issues in mobile Safari. |
...
| [#4210](https://github.com/tscircuit/tscircuit.com/pull/4210) | 🐌 Tiny | tscircuitbot | Updates the tscircuiteval package from version 0.0.1120 to 0.0.1121 |
...
| [#4201](https://github.com/tscircuit/tscircuit.com/pull/4201) | 🐌 Tiny | tscircuitbot | Automated package update |
...
| [#4186](https://github.com/tscircuit/tscircuit.com/pull/4186) | 🐌 Tiny | tscircuitbot | Updates the tscircuiteval package from version 0.0.1110 to 0.0.1111 |
| [#4185](https://github.com/tscircuit/tscircuit.com/pull/4185) | 🐌 Tiny | tscircuitbot | Updates the tscircuitrunframe package from version 0.0.2331 to 0.0.2332 |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#33](https://github.com/tscircuit/datasheet-to-tscircuit/pull/33) | 🐳 Major | ⭐⭐⭐ | ShiboSoftwareDev | Grounds model generation in independently verified datasheet graphs, immutable electrical bindings, and exact application fixtures. Adds bounded candidate search and repair with real ngspice and tscircuit waveform, causality, sensitivity, and holdout validation. Hardens evidence provenance, connectivity, artifact isolation, atomic publication, recovery, and preview integrity with fail-closed proof checks. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#17](https://github.com/tscircuit/fast-footprint-compare/pull/17) | 🐌 Tiny | Abse2001 | Updates the Footprinter and circuit-json-to-footprinter dependencies to their latest versions in package.json |
...
| [#2994](https://github.com/tscircuit/core/pull/2994) | 🐳 Major | ⭐⭐⭐ | Disables legacy autorouters by default, requiring explicit opt-in for legacy behavior and migrating tests to the default autorouter. |
| [#2992](https://github.com/tscircuit/core/pull/2992) | 🐳 Major | ⭐⭐⭐ | Prevents autorouting from starting when placement checks fail or when trace lengths exceed maximum limits, ensuring more reliable PCB designs. |
...
| [#7](https://github.com/tscircuit/header-modules/pull/7) | 🐳 Major | ⭐⭐⭐ | Promotes the remaining 280 catalog components from generated definitions to dedicated idiomatic TSX files. Each module now has an explicit chip , concrete pinLabelspinAttributes, a unique bordered and labeled female headermodule footprint, and a dedicated PCB  schematic snapshot test. Also removes the component blocks from generatedModules.tsx, exports every module directly from index.ts, and updates the catalog documentation to reflect that all 427 entries are implemented as dedicated modules. Validation: bun run typecheck bun test (438 tests, 0 failures) bun run build bun run snapshot npx tsci check schematic-placement unique-footprint and complete-pin-metadata audit git diff --check |
...
| [#2999](https://github.com/tscircuit/core/pull/2999) | 🐙 Minor | ⭐⭐ | Emit resolved DDR routing constraints including bus maxLengthSkew, traceWidth, allowedLayers, and differential-pair traceGap and maxUncoupledLength through existing adapters, while maintaining existing design compatibility. |
| [#2990](https://github.com/tscircuit/core/pull/2990) | 🐙 Minor | ⭐⭐ | Fixes incorrect assembly orientations by storing the normalized, accumulated PCB transform rotation for components within rotated groups. |
| [#2980](https://github.com/tscircuit/core/pull/2980) | 🐙 Minor | ⭐⭐ | Preserves literal pcb_silkscreen_text.text values generated by the explicit silkscreenlabel(...) footprinter option when importing a footprinter result into core, allowing custom text to remain unchanged while resolving reference placeholders to the component name. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#2963](https://github.com/tscircuit/core/pull/2963) | 🐙 Minor | ⭐⭐ | Adds support for fabrication note text rotation in Circuit JSON, ensuring correct orientation when rendered or reconstructed. |
...
| [#2986](https://github.com/tscircuit/core/pull/2986) | 🐌 Tiny | Updates the package version of tscircuitinfer-cable-insertion-point from 0.0.2 to 0.0.3 in package.json |
...
| [#2972](https://github.com/tscircuit/core/pull/2972) | 🐌 Tiny | Updates the tscircuitchecks package from version 0.0.147 to 0.0.148 |
...
| [#4210](https://github.com/tscircuit/tscircuit.com/pull/4210) | 🐌 Tiny | Updates the tscircuiteval package from version 0.0.1120 to 0.0.1121 |
...
| [#4201](https://github.com/tscircuit/tscircuit.com/pull/4201) | 🐌 Tiny | Automated package update |
...
| [#4186](https://github.com/tscircuit/tscircuit.com/pull/4186) | 🐌 Tiny | Updates the tscircuiteval package from version 0.0.1110 to 0.0.1111 |
| [#4185](https://github.com/tscircuit/tscircuit.com/pull/4185) | 🐌 Tiny | Updates the tscircuitrunframe package from version 0.0.2331 to 0.0.2332 |
...
| [#17](https://github.com/tscircuit/fast-footprint-compare/pull/17) | 🐌 Tiny | Updates the Footprinter and circuit-json-to-footprinter dependencies to their latest versions in package.json |
...
| [#4177](https://github.com/tscircuit/tscircuit.com/pull/4177) | 🐳 Major | ⭐⭐⭐ | Replaces the CodeMirror-based CodeEditor in CodeAndPreview with WorkspaceCodeEditor from tscircuitmonaco-code-editor (v0.0.22), bringing the workspace UI (file sidebar, breadcrumb symbol navigation, quick-open, cross-file search) to the web editor and implements a mobile memory toggle to prevent out-of-memory issues in mobile Safari. |
...
| [#33](https://github.com/tscircuit/datasheet-to-tscircuit/pull/33) | 🐳 Major | ⭐⭐⭐ | Grounds model generation in independently verified datasheet graphs, immutable electrical bindings, and exact application fixtures. Adds bounded candidate search and repair with real ngspice and tscircuit waveform, causality, sensitivity, and holdout validation. Hardens evidence provenance, connectivity, artifact isolation, atomic publication, recovery, and preview integrity with fail-closed proof checks. |
