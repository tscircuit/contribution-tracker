...
| [ArnavK-09](#ArnavK-09) | 7 | 1 | 5 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
...
| [Ayushjhawar8](#Ayushjhawar8) | 0 | 3 | 2 | ⭐ | 0🔹 0🔶 0💎 |
...
|---|---|---|---|---|---|---|---|---|
| [tscircuitbot](#tscircuitbot) | 0 | 0 | 0 | 0 | 0 | 250 | 203 | 0 |
| [Ayushjhawar8](#Ayushjhawar8) | 13 | 5 | 0 | 0 | 0 | 6 | 5 | 0 |
| [seveibar](#seveibar) | 1 | 0 | 0 | 51 | 8 | 41 | 32 | 0 |
...
| [ArnavK-09](#ArnavK-09) | 10 | 7 | 1 | 0 | 0 | 13 | 13 | 0 |
...
|------|--------|--------|-------------|-------------|
| [#589](https://github.com/tscircuit/pcb-viewer/pull/589) | 🐙 Minor | ⭐⭐ | Ayushjhawar8 | Fixes the d key measurement tool to work reliably with a dual-trigger system by ensuring proper focus and mouse state checks before activation. |
...
|------|--------|-------------|-------------|
| [#606](https://github.com/tscircuit/pcb-viewer/pull/606) | 🐌 Tiny | tscircuitbot | Automated package update |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#91](https://github.com/tscircuit/graphics-debug/pull/91) | 🐙 Minor | ⭐⭐ | Ayushjhawar8 | Fixes the d key hotkey functionality in the DimensionOverlay component to ensure it works correctly when the mouse is not over the component and the component does not have focus. |
...
| [#61](https://github.com/tscircuit/status/pull/61) | 🐌 Tiny | ArnavK-09 | Changes the ignored services in the Discord notification script from a specific service to an empty array, affecting which services trigger notifications. |
| [#60](https://github.com/tscircuit/status/pull/60) | 🐌 Tiny | ArnavK-09 | Creates a separate file for the latest statuses to facilitate API consumption. |
...
|------|--------|-------------|
| [#606](https://github.com/tscircuit/pcb-viewer/pull/606) | 🐌 Tiny | Automated package update |
...
|------|--------|--------|-------------|
| [#589](https://github.com/tscircuit/pcb-viewer/pull/589) | 🐙 Minor | ⭐⭐ | Fixes the d key measurement tool to work reliably with a dual-trigger system by ensuring proper focus and mouse state checks before activation. |
...
| [#91](https://github.com/tscircuit/graphics-debug/pull/91) | 🐙 Minor | ⭐⭐ | Fixes the d key hotkey functionality in the DimensionOverlay component to ensure it works correctly when the mouse is not over the component and the component does not have focus. |
...
| [#61](https://github.com/tscircuit/status/pull/61) | 🐌 Tiny | Changes the ignored services in the Discord notification script from a specific service to an empty array, affecting which services trigger notifications. |
| [#60](https://github.com/tscircuit/status/pull/60) | 🐌 Tiny | Creates a separate file for the latest statuses to facilitate API consumption. |
