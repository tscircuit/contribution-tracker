...
|---|---|---|---|---|---|---|---|---|---|---|
| [imrishabh18](#imrishabh18) | 12 | 9 | 1 | 7 | 5 | 20 | 19 | 10 | 8 | 55 |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 1 | 0 | 1 | 0 | 0 | 1 | 0 | 4 | 0 | 0 |
| [seveibar](#seveibar) | 0 | 0 | 0 | 34 | 7 | 26 | 25 | 21 | 13 | 422 |
| [andrii-balitskyi](#andrii-balitskyi) | 3 | 3 | 0 | 0 | 0 | 4 | 3 | 1 | 0 | 0 |
| [techmannih](#techmannih) | 4 | 1 | 2 | 0 | 0 | 5 | 1 | 1 | 1 | 3 |
...
|------|--------|-------------|-------------|-------------------|
| [#736](https://github.com/tscircuit/core/pull/736) | 🐳 Major | imrishabh18 | Ports the `applyEditEvents` method from `pcb-viewer` to the `core` library. | ❌ |
...
| [#738](https://github.com/tscircuit/core/pull/738) | 🐳 Major | seveibar | Update the Autorouter to fix issues with LED Matrix, CFrm transition, Keyboard5, and remove useless vias. | ✅ |
...
| [#737](https://github.com/tscircuit/core/pull/737) | 🐙 Minor | imrishabh18 | Add missing public export for `applyEditsToCircuitJson` function. | ✅ |
...
| PR # | Impact | Contributor | Description | Milestone Aligned |
|------|--------|-------------|-------------|-------------------|
| [#849](https://github.com/tscircuit/tscircuit.com/pull/849) | 🐳 Major | imrishabh18 | Adds a new schema for order quotes, including information about shipping options, quoted components, and the overall order quote. | ❌ |
...
| [#823](https://github.com/tscircuit/tscircuit.com/pull/823) | 🐳 Major | ArnavK-09 | Introduce license selection and automatic LICENSE file generation for packages, enhancing package metadata management and ensuring compliance with licensing requirements. | ✅ |
...
| [#857](https://github.com/tscircuit/tscircuit.com/pull/857) | 🐙 Minor | imrishabh18 | Update dependencies for `@tscircuit/core` and `@tscircuit/runframe` | ✅ |
...
| [#856](https://github.com/tscircuit/tscircuit.com/pull/856) | 🐙 Minor | MustafaMulla29 | Restricts the 'Delete Snippet' and 'Change Package Visibility' buttons to the owner of the snippet and fixes the error toast variant. | ❌ |
...
| [#854](https://github.com/tscircuit/tscircuit.com/pull/854) | 🐌 Tiny | imrishabh18 | Remove the Playwright workflow for the time being. | ❌ |
...
| [#460](https://github.com/tscircuit/runframe/pull/460) | 🐙 Minor | imrishabh18 | Update versions of @tscircuit/core and @tscircuit/pcb-viewer packages. | ✅ |
...
| PR # | Impact | Contributor | Description | Milestone Aligned |
|------|--------|-------------|-------------|-------------------|
| [#226](https://github.com/tscircuit/pcb-viewer/pull/226) | 🐙 Minor | imrishabh18 | Fix to apply the edit event movement only once when a component is moved. | ✅ |
| [#229](https://github.com/tscircuit/pcb-viewer/pull/229) | 🐌 Tiny | imrishabh18 | Updates the lockfile to fix npm publish | ❌ |

### [tscircuit/cli](https://github.com/tscircuit/cli)

| PR # | Impact | Contributor | Description | Milestone Aligned |
|------|--------|-------------|-------------|-------------------|
| [#163](https://github.com/tscircuit/cli/pull/163) | 🐙 Minor | imrishabh18 | Update the version of the "@tscircuit/runframe" dependency. | ✅ |
...
| [#95](https://github.com/tscircuit/unravel-autorouter/pull/95) | 🐙 Minor | seveibar | Fix an issue with the LED Matrix / Closed Form Transition Solver | ✅ |
...
|------|--------|-------------|-------------------|
| [#736](https://github.com/tscircuit/core/pull/736) | 🐳 Major | Ports the `applyEditEvents` method from `pcb-viewer` to the `core` library. | ❌ |
...
| [#849](https://github.com/tscircuit/tscircuit.com/pull/849) | 🐳 Major | Adds a new schema for order quotes, including information about shipping options, quoted components, and the overall order quote. | ❌ |
...
| [#226](https://github.com/tscircuit/pcb-viewer/pull/226) | 🐙 Minor | Fix to apply the edit event movement only once when a component is moved. | ✅ |
| [#737](https://github.com/tscircuit/core/pull/737) | 🐙 Minor | Add missing public export for `applyEditsToCircuitJson` function. | ✅ |
| [#857](https://github.com/tscircuit/tscircuit.com/pull/857) | 🐙 Minor | Update dependencies for `@tscircuit/core` and `@tscircuit/runframe` | ✅ |
...
| [#460](https://github.com/tscircuit/runframe/pull/460) | 🐙 Minor | Update versions of @tscircuit/core and @tscircuit/pcb-viewer packages. | ✅ |
| [#440](https://github.com/tscircuit/runframe/pull/440) | 🐙 Minor | Fix publish workflow | ✅ |
| [#163](https://github.com/tscircuit/cli/pull/163) | 🐙 Minor | Update the version of the "@tscircuit/runframe" dependency. | ✅ |
| [#229](https://github.com/tscircuit/pcb-viewer/pull/229) | 🐌 Tiny | Updates the lockfile to fix npm publish | ❌ |
| [#854](https://github.com/tscircuit/tscircuit.com/pull/854) | 🐌 Tiny | Remove the Playwright workflow for the time being. | ❌ |

### [seveibar](https://github.com/seveibar)

| PR # | Impact | Description | Milestone Aligned |
|------|--------|-------------|-------------------|
| [#738](https://github.com/tscircuit/core/pull/738) | 🐳 Major | Update the Autorouter to fix issues with LED Matrix, CFrm transition, Keyboard5, and remove useless vias. | ✅ |
