...
|-------------|---------|---------|---------|-----|--------------------------|
| [ArnavK-09](#ArnavK-09) | 6 | 3 | 6 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [rushabhcodes](#rushabhcodes) | 4 | 1 | 2 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [seveibar](#seveibar) | 7 | 2 | 2 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 2 | 7 | 2 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [imrishabh18](#imrishabh18) | 5 | 5 | 3 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [techmannih](#techmannih) | 3 | 4 | 2 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [Abse2001](#Abse2001) | 2 | 8 | 1 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [AnasSarkiz](#AnasSarkiz) | 5 | 3 | 5 | ⭐⭐⭐ | 0🔹 0🔶 0💎 |
| [0hmX](#0hmX) | 7 | 0 | 0 | ⭐⭐ | 0🔹 0🔶 0💎 |
| [tscircuitbot](#tscircuitbot) | 0 | 0 | 213 | ⭐⭐ | 0🔹 0🔶 0💎 |
| [Ayushjhawar8](#Ayushjhawar8) | 1 | 2 | 6 | ⭐⭐ | 0🔹 0🔶 0💎 |
| [MustafaMulla29](#MustafaMulla29) | 1 | 4 | 1 | ⭐⭐ | 0🔹 0🔶 0💎 |
...
|---|---|---|---|---|---|---|---|---|
| [MustafaMulla29](#MustafaMulla29) | 7 | 3 | 0 | 0 | 0 | 6 | 6 | 0 |
| [bimakw](#bimakw) | 6 | 1 | 3 | 0 | 0 | 6 | 0 | 0 |
| [rushabhcodes](#rushabhcodes) | 44 | 7 | 6 | 2 | 9 | 15 | 7 | 0 |
| [Abse2001](#Abse2001) | 12 | 11 | 0 | 6 | 0 | 12 | 11 | 0 |
| [ShiboSoftwareDev](#ShiboSoftwareDev) | 21 | 10 | 2 | 10 | 0 | 15 | 12 | 0 |
| [seveibar](#seveibar) | 0 | 0 | 0 | 53 | 15 | 15 | 11 | 0 |
| [tscircuitbot](#tscircuitbot) | 0 | 0 | 0 | 0 | 0 | 258 | 213 | 0 |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#1840](https://github.com/tscircuit/core/pull/1840) | 🐳 Major | ⭐⭐⭐ | ShiboSoftwareDev | Adds a new PanelBoardLayout render phase that computes board positions before PCB rendering, ensuring proper transform-based positioning for boards inside panels and eliminating post-render repositioning issues. |
| [#1843](https://github.com/tscircuit/core/pull/1843) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Optimizes the doInitialPcbLayout phase by eliminating expensive database scans, improving performance during PCB layout initialization. |
| [#1839](https://github.com/tscircuit/core/pull/1839) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Optimizes the handling of duplicate component names within subcircuits by implementing a caching mechanism for component name mapping. |
...
| [#1845](https://github.com/tscircuit/core/pull/1845) | 🐙 Minor | ⭐⭐ | ShiboSoftwareDev | Adds scaling logic to reduce tab width and length for small boards, implementing a minimum scale factor to maintain usability and includes a test case for verification. |
...
| [#1841](https://github.com/tscircuit/core/pull/1841) | 🐙 Minor | ⭐⭐ | imrishabh18 | Fixes a bug where the initial parts engine render was still executed even when partsEngineDisabled was set to true. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#1878](https://github.com/tscircuit/eval/pull/1878) | 🐙 Minor | ⭐⭐ | MustafaMulla29 | Adds a fragment identifier to blob URLs for STEP files to ensure correct file type detection and prevent fallback to STL URLs, resolving warnings in the console. |
| [#1874](https://github.com/tscircuit/eval/pull/1874) | 🐙 Minor | ⭐⭐ | ShiboSoftwareDev | Fixes critical Error resolving module specifier npmeecircuit-engine1.5.6esm error that breaks ngspice SPICE simulations in browser environments |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#1666](https://github.com/tscircuit/cli/pull/1666) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Adds concurrency support to the build process, allowing multiple files to be built in parallel, significantly reducing build time from 10 minutes to approximately 5 minutes for 4 concurrent builds. |
| [#1661](https://github.com/tscircuit/cli/pull/1661) | 🐙 Minor | ⭐⭐ | MustafaMulla29 | Adds support for generating KiCad PCM (Plugin and Content Manager) assets in the distpcm directory during the build process with a new --kicad-pcm flag. |
| [#1670](https://github.com/tscircuit/cli/pull/1670) | 🐙 Minor | ⭐⭐ | MustafaMulla29 | Adds a new boolean entry kicadPcm to the tscircuit configuration schema to enable KiCad PCM assets output in the build. |
| [#1654](https://github.com/tscircuit/cli/pull/1654) | 🐙 Minor | ⭐⭐ | imrishabh18 | Adds support for generating KiCad footprint libraries during the CI build process using the tsci build --ci command. |
| [#1634](https://github.com/tscircuit/cli/pull/1634) | 🐙 Minor | ⭐⭐ | imrishabh18 | Add a project config option to let a project declare the default component to show when generating a static site so the generated site can open a chosen circuit by default. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#1673](https://github.com/tscircuit/cli/pull/1673) | 🐌 Tiny | tscircuitbot | Updates the tscircuitrunframe package from version 0.0.1496 to 0.0.1497 |
| [#1672](https://github.com/tscircuit/cli/pull/1672) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1674](https://github.com/tscircuit/cli/pull/1674) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1671](https://github.com/tscircuit/cli/pull/1671) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1669](https://github.com/tscircuit/cli/pull/1669) | 🐌 Tiny | tscircuitbot | Automated package update |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#659](https://github.com/tscircuit/3d-viewer/pull/659) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Implements layer-aware Z-positioning for CAD components to ensure accurate placement on PCB surfaces based on board thickness, centralizing positioning logic across multiple model formats and enhancing test coverage for panelization. |
| [#661](https://github.com/tscircuit/3d-viewer/pull/661) | 🐙 Minor | ⭐⭐ | Abse2001 | Fixes geometry edge case that could cause JSCAD to throw during rounded-rectangle generation by aligning border-radius clamping logic with JSCADs internal constraints. |
| [#662](https://github.com/tscircuit/3d-viewer/pull/662) | 🐙 Minor | ⭐⭐ | Abse2001 | Fixes incorrect orientation of bottom-layer CAD components by correcting Z-axis rotation handling during layer flipping. |
| [#660](https://github.com/tscircuit/3d-viewer/pull/660) | 🐙 Minor | ⭐⭐ | Abse2001 | Fixes a rendering bug in the JSCAD viewer by standardizing the default PCB thickness from 1.6 mm to 1.4 mm, ensuring consistent soldermask visualization across panelized boards. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#119](https://github.com/tscircuit/circuit-to-canvas/pull/119) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Introduces a dedicated soldermask rendering engine with correct positivenegative margin semantics. Reorders the entire draw pipeline to match real PCB fabrication layers (substrate  copper  soldermask  silkscreen  drills). Simplifies pad, hole, and plated-hole rendering by removing inline soldermask hacks and centralizing logic. Fixes long-standing visual inaccuracies for soldermask coverage, margins, and cutouts across all shapes. Updates snapshots to reflect physically accurate PCB output. |
| [#123](https://github.com/tscircuit/circuit-to-canvas/pull/123) | 🐙 Minor | ⭐⭐ | Abse2001 | Fixes incorrect silkscreen text placement by properly handling all center-based anchor alignments and locking the behavior down with a comprehensive visual regression test. |
| [#121](https://github.com/tscircuit/circuit-to-canvas/pull/121) | 🐙 Minor | ⭐⭐ | Abse2001 | This PR introduces an explicit rendering switch to separate PCB outline drawing from substrate (front material) fill, eliminating unintended visual occlusion and improving layer correctness across canvas renders. |
| [#116](https://github.com/tscircuit/circuit-to-canvas/pull/116) | 🐙 Minor | ⭐⭐ | Ayushjhawar8 | Add support for rendering multi-line text in copper and silkscreen layers of PCB designs, allowing for better text representation in circuit designs. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#611](https://github.com/tscircuit/pcb-viewer/pull/611) | 🐙 Minor | ⭐⭐ | Abse2001 | Fixes inconsistent soldermask rendering by threading the soldermask visibility flag through the entire canvas drawing pipeline and aligning the viewer with the latest circuit-to-canvas behavior. |
| [#614](https://github.com/tscircuit/pcb-viewer/pull/614) | 🐙 Minor | ⭐⭐ | Abse2001 | Fixes missing SMT pad rendering on inner copper layers by fully extending the canvas render pipeline to support pads on multilayer boards. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#1906](https://github.com/tscircuit/tscircuit/pull/1906) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1905](https://github.com/tscircuit/tscircuit/pull/1905) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1904](https://github.com/tscircuit/tscircuit/pull/1904) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1903](https://github.com/tscircuit/tscircuit/pull/1903) | 🐌 Tiny | tscircuitbot | Updates the tscircuitcli package from version 0.1.772 to 0.1.773 and the tscircuitrunframe package from version 0.0.1496 to 0.0.1497 in package.json |
| [#1899](https://github.com/tscircuit/tscircuit/pull/1899) | 🐌 Tiny | tscircuitbot | Updates the package version from 0.0.1164 to 0.0.1165 in package.json |
| [#1898](https://github.com/tscircuit/tscircuit/pull/1898) | 🐌 Tiny | tscircuitbot | Updates the tscircuitcli package to version 0.1.771 in the package.json file |
| [#1896](https://github.com/tscircuit/tscircuit/pull/1896) | 🐌 Tiny | tscircuitbot | Updates the tscircuitcli package from version 0.1.769 to 0.1.770 |
| [#1900](https://github.com/tscircuit/tscircuit/pull/1900) | 🐌 Tiny | tscircuitbot | Updates the tscircuitcli package to version 0.1.772 in the package.json file. |
| [#1897](https://github.com/tscircuit/tscircuit/pull/1897) | 🐌 Tiny | tscircuitbot | Automated package update |
| [#1901](https://github.com/tscircuit/tscircuit/pull/1901) | 🐌 Tiny | tscircuitbot | Automated package update |
...
| [#2507](https://github.com/tscircuit/tscircuit.com/pull/2507) | 🐳 Major | ⭐⭐⭐ | ArnavK-09 | Added Tooltip functionality to display full date in SidebarReleasesSection, updated links to direct to specific release versions, implemented mobile and desktop dropdowns in BuildItemRow and ReleaseItemRow for better action management, and improved layout and styling for better user experience. |
| [#2513](https://github.com/tscircuit/tscircuit.com/pull/2513) | 🐳 Major | ⭐⭐⭐ | ArnavK-09 | Implements an organization settings page and a new package save prompt dialog, enhancing user interaction with package creation and organization management. |
| [#2506](https://github.com/tscircuit/tscircuit.com/pull/2506) | 🐳 Major | ⭐⭐⭐ | ArnavK-09 | Adds a detailed view for build information, including logs and deployment details for specific builds of a package release. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#2517](https://github.com/tscircuit/tscircuit.com/pull/2517) | 🐌 Tiny | tscircuitbot | Updates the tscircuitrunframe package from version 0.0.1496 to 0.0.1497 |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#2354](https://github.com/tscircuit/runframe/pull/2354) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Adds support for TSCIRCUIT_DEFAULT_MAIN_COMPONENT_PATH to set a default preview path for circuits in the RunFrame component. |
| [#2367](https://github.com/tscircuit/runframe/pull/2367) | 🐳 Major | ⭐⭐⭐ | ArnavK-09 | Adds functionality to override the default tab selection in the RunFrame static viewer based on URL parameters. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#2368](https://github.com/tscircuit/runframe/pull/2368) | 🐌 Tiny | tscircuitbot | Automated package update |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#850](https://github.com/tscircuit/svg.tscircuit.com/pull/850) | 🐌 Tiny | tscircuitbot | Updates the tscircuit package version from 0.0.1165 to 0.0.1166 in package.json |
| [#849](https://github.com/tscircuit/svg.tscircuit.com/pull/849) | 🐌 Tiny | tscircuitbot | Updates the tscircuit package from version 0.0.1164 to 0.0.1165 in package.json |
| [#848](https://github.com/tscircuit/svg.tscircuit.com/pull/848) | 🐌 Tiny | tscircuitbot | Updates the tscircuit package from version 0.0.1163 to 0.0.1164 in package.json |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#67](https://github.com/tscircuit/rectdiff/pull/67) | 🐳 Major | ⭐⭐⭐ | 0hmX | Adds obstacle clearance functionality to improve routing efficiency by adjusting the capacity node distance from obstacles, allowing for less post-processing. |
| [#69](https://github.com/tscircuit/rectdiff/pull/69) | 🐳 Major | ⭐⭐⭐ | 0hmX | Fixes visualization issues related to obstacle overlap and gaps, adds z layer labels, and introduces a new test for output consistency. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#21](https://github.com/tscircuit/lbrnts/pull/21) | 🐳 Major | ⭐⭐⭐ | seveibar | Adds support for rendering polygon cutouts in SVG, allowing for complex shapes with holes to be represented accurately. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#93](https://github.com/tscircuit/circuit-json-to-lbrn/pull/93) | 🐳 Major | ⭐⭐⭐ | seveibar | copper fill1 copper fill fix |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#28](https://github.com/tscircuit/hypergraph/pull/28) | 🐳 Major | ⭐⭐⭐ | ArnavK-09 | Fixes the website preview rendering issue by adjusting the Vite configuration to deduplicate React and React-DOM dependencies. |
...
| [#537](https://github.com/tscircuit/tscircuit-autorouter/pull/537) | 🐳 Major | ⭐⭐⭐ | 0hmX | Applies z layer checks and integrates the Trace Width Solver to address trace clearance issues in autorouting. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#484](https://github.com/tscircuit/footprinter/pull/484) | 🐳 Major | ⭐⭐⭐ | rushabhcodes | Adds support for rendering USB connectors on the silkscreen of mounted PCB modules, including new parameters for USB position and type, updated rendering logic, and a test for the new feature. |
| [#485](https://github.com/tscircuit/footprinter/pull/485) | 🐳 Major | ⭐⭐⭐ | rushabhcodes | Refactors the TSSOP footprint generator to enhance parameter handling and custom padsilkscreen generation, improving flexibility and accuracy for TSSOP footprints. |
...
| [#487](https://github.com/tscircuit/footprinter/pull/487) | 🐙 Minor | ⭐⭐ | rushabhcodes | Adds support for specifying individual pin counts on each side of the mounted PCB module, including updates to schema validation, calculation logic, pin rendering, and new tests. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#5](https://github.com/tscircuit/dimension-placement-solver/pull/5) | 🐳 Major | ⭐⭐⭐ | ShiboSoftwareDev | This enhancement splits diagonal offsets in PCB layouts into sequential horizontal and vertical dimensions, improving clarity in component positioning. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#114](https://github.com/tscircuit/jlcsearch/pull/114) | 🐙 Minor | ⭐⭐ | ArnavK-09 | Fixes an issue where the search functionality throws errors when the search term contains dots. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#37](https://github.com/tscircuit/pcbburn.com/pull/37) | 🐳 Major | ⭐⭐⭐ | AnasSarkiz | This PR transforms the preview canvas UX by replacing two non-functional rotate buttons with three interactive zoom controls: Zoom In (), Zoom Out (-), and Fit to Screen (magnifying glass icon). Unlike the previous inert placeholders, these buttons now enable smooth, center-focused scaling that zooms towards the geometric center of each view container (LBRNPCB), maintaining visual stability and user focus during interactions. |
| [#33](https://github.com/tscircuit/pcbburn.com/pull/33) | 🐳 Major | ⭐⭐⭐ | AnasSarkiz | Generates LBRN and PCB SVGs only when their views are active, splitting preview rendering to avoid redundant work on every settings change while maintaining a unified loading state and reducing CPU load. |
| [#34](https://github.com/tscircuit/pcbburn.com/pull/34) | 🐳 Major | ⭐⭐⭐ | AnasSarkiz | Caches the last LBRN inputs and PCB circuit to skip SVG regeneration when switching views without data changes, avoiding unnecessary work by reusing existing SVGs while keeping loading state accurate. |
...
| [#1878](https://github.com/tscircuit/eval/pull/1878) | 🐙 Minor | ⭐⭐ | Adds a fragment identifier to blob URLs for STEP files to ensure correct file type detection and prevent fallback to STL URLs, resolving warnings in the console. |
| [#1661](https://github.com/tscircuit/cli/pull/1661) | 🐙 Minor | ⭐⭐ | Adds support for generating KiCad PCM (Plugin and Content Manager) assets in the distpcm directory during the build process with a new --kicad-pcm flag. |
| [#1670](https://github.com/tscircuit/cli/pull/1670) | 🐙 Minor | ⭐⭐ | Adds a new boolean entry kicadPcm to the tscircuit configuration schema to enable KiCad PCM assets output in the build. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#659](https://github.com/tscircuit/3d-viewer/pull/659) | 🐳 Major | ⭐⭐⭐ | Implements layer-aware Z-positioning for CAD components to ensure accurate placement on PCB surfaces based on board thickness, centralizing positioning logic across multiple model formats and enhancing test coverage for panelization. |
| [#119](https://github.com/tscircuit/circuit-to-canvas/pull/119) | 🐳 Major | ⭐⭐⭐ | Introduces a dedicated soldermask rendering engine with correct positivenegative margin semantics. Reorders the entire draw pipeline to match real PCB fabrication layers (substrate  copper  soldermask  silkscreen  drills). Simplifies pad, hole, and plated-hole rendering by removing inline soldermask hacks and centralizing logic. Fixes long-standing visual inaccuracies for soldermask coverage, margins, and cutouts across all shapes. Updates snapshots to reflect physically accurate PCB output. |
| [#611](https://github.com/tscircuit/pcb-viewer/pull/611) | 🐙 Minor | ⭐⭐ | Fixes inconsistent soldermask rendering by threading the soldermask visibility flag through the entire canvas drawing pipeline and aligning the viewer with the latest circuit-to-canvas behavior. |
| [#614](https://github.com/tscircuit/pcb-viewer/pull/614) | 🐙 Minor | ⭐⭐ | Fixes missing SMT pad rendering on inner copper layers by fully extending the canvas render pipeline to support pads on multilayer boards. |
| [#661](https://github.com/tscircuit/3d-viewer/pull/661) | 🐙 Minor | ⭐⭐ | Fixes geometry edge case that could cause JSCAD to throw during rounded-rectangle generation by aligning border-radius clamping logic with JSCADs internal constraints. |
| [#662](https://github.com/tscircuit/3d-viewer/pull/662) | 🐙 Minor | ⭐⭐ | Fixes incorrect orientation of bottom-layer CAD components by correcting Z-axis rotation handling during layer flipping. |
| [#660](https://github.com/tscircuit/3d-viewer/pull/660) | 🐙 Minor | ⭐⭐ | Fixes a rendering bug in the JSCAD viewer by standardizing the default PCB thickness from 1.6 mm to 1.4 mm, ensuring consistent soldermask visualization across panelized boards. |
...
| [#123](https://github.com/tscircuit/circuit-to-canvas/pull/123) | 🐙 Minor | ⭐⭐ | Fixes incorrect silkscreen text placement by properly handling all center-based anchor alignments and locking the behavior down with a comprehensive visual regression test. |
| [#121](https://github.com/tscircuit/circuit-to-canvas/pull/121) | 🐙 Minor | ⭐⭐ | This PR introduces an explicit rendering switch to separate PCB outline drawing from substrate (front material) fill, eliminating unintended visual occlusion and improving layer correctness across canvas renders. |
...
<details>
<summary>🐌 Tiny Contributions (213)</summary>
...
| [#1906](https://github.com/tscircuit/tscircuit/pull/1906) | 🐌 Tiny | Automated package update |
| [#1905](https://github.com/tscircuit/tscircuit/pull/1905) | 🐌 Tiny | Automated package update |
| [#1904](https://github.com/tscircuit/tscircuit/pull/1904) | 🐌 Tiny | Automated package update |
| [#1903](https://github.com/tscircuit/tscircuit/pull/1903) | 🐌 Tiny | Updates the tscircuitcli package from version 0.1.772 to 0.1.773 and the tscircuitrunframe package from version 0.0.1496 to 0.0.1497 in package.json |
| [#1899](https://github.com/tscircuit/tscircuit/pull/1899) | 🐌 Tiny | Updates the package version from 0.0.1164 to 0.0.1165 in package.json |
| [#1898](https://github.com/tscircuit/tscircuit/pull/1898) | 🐌 Tiny | Updates the tscircuitcli package to version 0.1.771 in the package.json file |
| [#1896](https://github.com/tscircuit/tscircuit/pull/1896) | 🐌 Tiny | Updates the tscircuitcli package from version 0.1.769 to 0.1.770 |
| [#1900](https://github.com/tscircuit/tscircuit/pull/1900) | 🐌 Tiny | Updates the tscircuitcli package to version 0.1.772 in the package.json file. |
| [#1897](https://github.com/tscircuit/tscircuit/pull/1897) | 🐌 Tiny | Automated package update |
| [#1901](https://github.com/tscircuit/tscircuit/pull/1901) | 🐌 Tiny | Automated package update |
...
| [#2517](https://github.com/tscircuit/tscircuit.com/pull/2517) | 🐌 Tiny | Updates the tscircuitrunframe package from version 0.0.1496 to 0.0.1497 |
...
| [#2368](https://github.com/tscircuit/runframe/pull/2368) | 🐌 Tiny | Automated package update |
...
| [#1673](https://github.com/tscircuit/cli/pull/1673) | 🐌 Tiny | Updates the tscircuitrunframe package from version 0.0.1496 to 0.0.1497 |
| [#1672](https://github.com/tscircuit/cli/pull/1672) | 🐌 Tiny | Automated package update |
| [#1674](https://github.com/tscircuit/cli/pull/1674) | 🐌 Tiny | Automated package update |
| [#1671](https://github.com/tscircuit/cli/pull/1671) | 🐌 Tiny | Automated package update |
| [#1669](https://github.com/tscircuit/cli/pull/1669) | 🐌 Tiny | Automated package update |
...
| [#850](https://github.com/tscircuit/svg.tscircuit.com/pull/850) | 🐌 Tiny | Updates the tscircuit package version from 0.0.1165 to 0.0.1166 in package.json |
| [#849](https://github.com/tscircuit/svg.tscircuit.com/pull/849) | 🐌 Tiny | Updates the tscircuit package from version 0.0.1164 to 0.0.1165 in package.json |
| [#848](https://github.com/tscircuit/svg.tscircuit.com/pull/848) | 🐌 Tiny | Updates the tscircuit package from version 0.0.1163 to 0.0.1164 in package.json |
...
| [#116](https://github.com/tscircuit/circuit-to-canvas/pull/116) | 🐙 Minor | ⭐⭐ | Add support for rendering multi-line text in copper and silkscreen layers of PCB designs, allowing for better text representation in circuit designs. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#484](https://github.com/tscircuit/footprinter/pull/484) | 🐳 Major | ⭐⭐⭐ | Adds support for rendering USB connectors on the silkscreen of mounted PCB modules, including new parameters for USB position and type, updated rendering logic, and a test for the new feature. |
| [#485](https://github.com/tscircuit/footprinter/pull/485) | 🐳 Major | ⭐⭐⭐ | Refactors the TSSOP footprint generator to enhance parameter handling and custom padsilkscreen generation, improving flexibility and accuracy for TSSOP footprints. |
...
| [#487](https://github.com/tscircuit/footprinter/pull/487) | 🐙 Minor | ⭐⭐ | Adds support for specifying individual pin counts on each side of the mounted PCB module, including updates to schema validation, calculation logic, pin rendering, and new tests. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#1840](https://github.com/tscircuit/core/pull/1840) | 🐳 Major | ⭐⭐⭐ | Adds a new PanelBoardLayout render phase that computes board positions before PCB rendering, ensuring proper transform-based positioning for boards inside panels and eliminating post-render repositioning issues. |
| [#5](https://github.com/tscircuit/dimension-placement-solver/pull/5) | 🐳 Major | ⭐⭐⭐ | This enhancement splits diagonal offsets in PCB layouts into sequential horizontal and vertical dimensions, improving clarity in component positioning. |
...
| [#1845](https://github.com/tscircuit/core/pull/1845) | 🐙 Minor | ⭐⭐ | Adds scaling logic to reduce tab width and length for small boards, implementing a minimum scale factor to maintain usability and includes a test case for verification. |
...
| [#1874](https://github.com/tscircuit/eval/pull/1874) | 🐙 Minor | ⭐⭐ | Fixes critical Error resolving module specifier npmeecircuit-engine1.5.6esm error that breaks ngspice SPICE simulations in browser environments |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#1843](https://github.com/tscircuit/core/pull/1843) | 🐳 Major | ⭐⭐⭐ | Optimizes the doInitialPcbLayout phase by eliminating expensive database scans, improving performance during PCB layout initialization. |
| [#1839](https://github.com/tscircuit/core/pull/1839) | 🐳 Major | ⭐⭐⭐ | Optimizes the handling of duplicate component names within subcircuits by implementing a caching mechanism for component name mapping. |
...
| [#2354](https://github.com/tscircuit/runframe/pull/2354) | 🐳 Major | ⭐⭐⭐ | Adds support for TSCIRCUIT_DEFAULT_MAIN_COMPONENT_PATH to set a default preview path for circuits in the RunFrame component. |
| [#1666](https://github.com/tscircuit/cli/pull/1666) | 🐳 Major | ⭐⭐⭐ | Adds concurrency support to the build process, allowing multiple files to be built in parallel, significantly reducing build time from 10 minutes to approximately 5 minutes for 4 concurrent builds. |
| [#1841](https://github.com/tscircuit/core/pull/1841) | 🐙 Minor | ⭐⭐ | Fixes a bug where the initial parts engine render was still executed even when partsEngineDisabled was set to true. |
| [#1654](https://github.com/tscircuit/cli/pull/1654) | 🐙 Minor | ⭐⭐ | Adds support for generating KiCad footprint libraries during the CI build process using the tsci build --ci command. |
| [#1634](https://github.com/tscircuit/cli/pull/1634) | 🐙 Minor | ⭐⭐ | Add a project config option to let a project declare the default component to show when generating a static site so the generated site can open a chosen circuit by default. |
...
| [#21](https://github.com/tscircuit/lbrnts/pull/21) | 🐳 Major | ⭐⭐⭐ | Adds support for rendering polygon cutouts in SVG, allowing for complex shapes with holes to be represented accurately. |
| [#93](https://github.com/tscircuit/circuit-json-to-lbrn/pull/93) | 🐳 Major | ⭐⭐⭐ | copper fill1 copper fill fix |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#2507](https://github.com/tscircuit/tscircuit.com/pull/2507) | 🐳 Major | ⭐⭐⭐ | Added Tooltip functionality to display full date in SidebarReleasesSection, updated links to direct to specific release versions, implemented mobile and desktop dropdowns in BuildItemRow and ReleaseItemRow for better action management, and improved layout and styling for better user experience. |
| [#2513](https://github.com/tscircuit/tscircuit.com/pull/2513) | 🐳 Major | ⭐⭐⭐ | Implements an organization settings page and a new package save prompt dialog, enhancing user interaction with package creation and organization management. |
| [#2506](https://github.com/tscircuit/tscircuit.com/pull/2506) | 🐳 Major | ⭐⭐⭐ | Adds a detailed view for build information, including logs and deployment details for specific builds of a package release. |
...
| [#2367](https://github.com/tscircuit/runframe/pull/2367) | 🐳 Major | ⭐⭐⭐ | Adds functionality to override the default tab selection in the RunFrame static viewer based on URL parameters. |
| [#28](https://github.com/tscircuit/hypergraph/pull/28) | 🐳 Major | ⭐⭐⭐ | Fixes the website preview rendering issue by adjusting the Vite configuration to deduplicate React and React-DOM dependencies. |
...
| [#114](https://github.com/tscircuit/jlcsearch/pull/114) | 🐙 Minor | ⭐⭐ | Fixes an issue where the search functionality throws errors when the search term contains dots. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#537](https://github.com/tscircuit/tscircuit-autorouter/pull/537) | 🐳 Major | ⭐⭐⭐ | Applies z layer checks and integrates the Trace Width Solver to address trace clearance issues in autorouting. |
...
| [#67](https://github.com/tscircuit/rectdiff/pull/67) | 🐳 Major | ⭐⭐⭐ | Adds obstacle clearance functionality to improve routing efficiency by adjusting the capacity node distance from obstacles, allowing for less post-processing. |
| [#69](https://github.com/tscircuit/rectdiff/pull/69) | 🐳 Major | ⭐⭐⭐ | Fixes visualization issues related to obstacle overlap and gaps, adds z layer labels, and introduces a new test for output consistency. |
...
|------|--------|--------|-------------|
| [#90](https://github.com/tscircuit/circuit-json-to-lbrn/pull/90) | 🐳 Major | ⭐⭐⭐ | Adds a Soldermask Margin () input field to the conversion options in the site UI and exposes the existing solderMaskMarginPercent library option to end users, allowing percentage-based solder mask margin adjustments alongside the existing absolute (mm) margin option |
| [#37](https://github.com/tscircuit/pcbburn.com/pull/37) | 🐳 Major | ⭐⭐⭐ | This PR transforms the preview canvas UX by replacing two non-functional rotate buttons with three interactive zoom controls: Zoom In (), Zoom Out (-), and Fit to Screen (magnifying glass icon). Unlike the previous inert placeholders, these buttons now enable smooth, center-focused scaling that zooms towards the geometric center of each view container (LBRNPCB), maintaining visual stability and user focus during interactions. |
| [#33](https://github.com/tscircuit/pcbburn.com/pull/33) | 🐳 Major | ⭐⭐⭐ | Generates LBRN and PCB SVGs only when their views are active, splitting preview rendering to avoid redundant work on every settings change while maintaining a unified loading state and reducing CPU load. |
| [#34](https://github.com/tscircuit/pcbburn.com/pull/34) | 🐳 Major | ⭐⭐⭐ | Caches the last LBRN inputs and PCB circuit to skip SVG regeneration when switching views without data changes, avoiding unnecessary work by reusing existing SVGs while keeping loading state accurate. |
