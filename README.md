...
| [#1100](https://github.com/tscircuit/tscircuit.com/pull/1100) | 🐙 Minor | imrishabh18 | Reverts the fix for the unmounting of the dropdown item. | ✅ |
| [#1087](https://github.com/tscircuit/tscircuit.com/pull/1087) | 🐙 Minor | imrishabh18 | Show sign in, when no user not logged in | ❌ |
| [#1095](https://github.com/tscircuit/tscircuit.com/pull/1095) | 🐙 Minor | imrishabh18 | Fix for the unmounting of the dropdown item. | ✅ |
...
| [#1096](https://github.com/tscircuit/tscircuit.com/pull/1096) | 🐙 Minor | MustafaMulla29 | Added a skeleton loading component for the user's profile page and made minor improvements to the empty state messages. | ❌ |
| [#1090](https://github.com/tscircuit/tscircuit.com/pull/1090) | 🐙 Minor | MustafaMulla29 | Added an optimized image component that shows a fallback image when the primary image doesn't load. | ✅ |
...
| [#1101](https://github.com/tscircuit/tscircuit.com/pull/1101) | 🐌 Tiny | Abse2001 | Updates the dependency `@tscircuit/runframe` from version `0.0.446` to `0.0.449`. | ❌ |
...
| [#800](https://github.com/tscircuit/core/pull/800) | 🐙 Minor | ShiboSoftwareDev | Fixed solder jumper pins not mapping correctly and disabled `cadModel` with empty string. | ✅ |
...
| [#226](https://github.com/tscircuit/props/pull/226) | 🐙 Minor | ShiboSoftwareDev | Allowing `cadModel` property to be `null` | ✅ |
...
| PR # | Impact | Contributor | Description | Milestone Aligned |
|------|--------|-------------|-------------|-------------------|
| [#593](https://github.com/tscircuit/runframe/pull/593) | 🐳 Major | imrishabh18 | Add the sign-in view on the dialog if the user is not logged in | ✅ |
...
| [#598](https://github.com/tscircuit/runframe/pull/598) | 🐙 Minor | imrishabh18 | Added the `isLoggedIn` parameter to the `useOrderDialog` hook and the `OrderDialog` component, allowing the sign-in dialog to be shown immediately if the user is not logged in. | ❌ |
| [#597](https://github.com/tscircuit/runframe/pull/597) | 🐙 Minor | imrishabh18 | Update the API parameter to a named parameter | ✅ |
| [#594](https://github.com/tscircuit/runframe/pull/594) | 🐙 Minor | imrishabh18 | Fix the condition for not showing both the loader and error message in the OrderDialog component. | ✅ |
...
| [#599](https://github.com/tscircuit/runframe/pull/599) | 🐙 Minor | seveibar | Fix routing failure to simulate error tab not working, show pcb_autorouting_error in errors tab | ✅ |
...
| [#10](https://github.com/tscircuit/template-api-fake/pull/10) | 🐌 Tiny | Anshgrover23 | The pull request refactors the middleware imports to use the correct path to the Middleware type. | ✅ |
...
| [#1101](https://github.com/tscircuit/tscircuit.com/pull/1101) | 🐌 Tiny | Updates the dependency `@tscircuit/runframe` from version `0.0.446` to `0.0.449`. | ❌ |
...
| [#226](https://github.com/tscircuit/props/pull/226) | 🐙 Minor | Allowing `cadModel` property to be `null` | ✅ |
| [#264](https://github.com/tscircuit/footprinter/pull/264) | 🐙 Minor | Adds silkscreen outline and reference text for solderjumper footprint | ✅ |
...
| [#800](https://github.com/tscircuit/core/pull/800) | 🐙 Minor | Fixed solder jumper pins not mapping correctly and disabled `cadModel` with empty string. | ✅ |
...
| [#593](https://github.com/tscircuit/runframe/pull/593) | 🐳 Major | Add the sign-in view on the dialog if the user is not logged in | ✅ |
...
| [#1100](https://github.com/tscircuit/tscircuit.com/pull/1100) | 🐙 Minor | Reverts the fix for the unmounting of the dropdown item. | ✅ |
| [#1087](https://github.com/tscircuit/tscircuit.com/pull/1087) | 🐙 Minor | Show sign in, when no user not logged in | ❌ |
| [#1095](https://github.com/tscircuit/tscircuit.com/pull/1095) | 🐙 Minor | Fix for the unmounting of the dropdown item. | ✅ |
...
| [#598](https://github.com/tscircuit/runframe/pull/598) | 🐙 Minor | Added the `isLoggedIn` parameter to the `useOrderDialog` hook and the `OrderDialog` component, allowing the sign-in dialog to be shown immediately if the user is not logged in. | ❌ |
| [#597](https://github.com/tscircuit/runframe/pull/597) | 🐙 Minor | Update the API parameter to a named parameter | ✅ |
| [#594](https://github.com/tscircuit/runframe/pull/594) | 🐙 Minor | Fix the condition for not showing both the loader and error message in the OrderDialog component. | ✅ |
...
| PR # | Impact | Description | Milestone Aligned |
|------|--------|-------------|-------------------|
| [#262](https://github.com/tscircuit/footprinter/pull/262) | 🐳 Major | Adds support for the potentiometer_ca14_h5 component. | ✅ |
...
| [#196](https://github.com/tscircuit/easyeda-converter/pull/196) | 🐙 Minor | Fix the z-axis rotation for the CAD component. | ✅ |
...
| [#122](https://github.com/tscircuit/tscircuit-autorouter/pull/122) | 🐳 Major | The pull request updates the .gitignore file and adds a new JSON file containing details about capacity pathing and multi-section capacity pathing. | ✅ |
...
| [#54](https://github.com/tscircuit/graphics-debug/pull/54) | 🐙 Minor | Add support for stroke-dasharray property in SVG generation | ✅ |
| [#53](https://github.com/tscircuit/graphics-debug/pull/53) | 🐙 Minor | Add an option to set the background color for the SVG image. | ✅ |
...
| [#599](https://github.com/tscircuit/runframe/pull/599) | 🐙 Minor | Fix routing failure to simulate error tab not working, show pcb_autorouting_error in errors tab | ✅ |
...
| [#121](https://github.com/tscircuit/tscircuit-autorouter/pull/121) | 🐙 Minor | The pull request adds comments with placeholders, uses section score as g in hyper capacity pathing section solver, adds a todo for starting score, updates the optimization schedule, adds a placeholder for cached hyper capacity pathing solver, and attempts to make the g score more efficient. | ✅ |
