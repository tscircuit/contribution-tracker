...
| [#133](https://github.com/tscircuit/sparkfun-boards/pull/133) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Adds a new SparkFun Qwiic Adapter circuit board with associated schematic and footprint files. |
| [#132](https://github.com/tscircuit/sparkfun-boards/pull/132) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Adds a new SparkFun Triple Axis Accelerometer Breakout ADXL362 with its schematic and footprint. |
| [#131](https://github.com/tscircuit/sparkfun-boards/pull/131) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Adds a new SparkFun USB Type-A Female Breakout board with associated schematic and footprint files. |
| [#129](https://github.com/tscircuit/sparkfun-boards/pull/129) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Adds a new SparkFun SOT23 to DIP adapter circuit board with associated documentation and schematic. |
| [#127](https://github.com/tscircuit/sparkfun-boards/pull/127) | 🐳 Major | ⭐⭐⭐ | Abse2001 | Adds a new SparkFun I2S Audio Breakout board with MAX98357A chip including schematic and footprint. |
...
| [#1574](https://github.com/tscircuit/tscircuit.com/pull/1574) | 🐳 Major | ⭐⭐⭐ | ArnavK-09 | Optimizes file content fetching in the ImportantFilesView component to prevent multiple requests and reduce loading latency. |
...
| [#1588](https://github.com/tscircuit/tscircuit.com/pull/1588) | 🐳 Major | ⭐⭐⭐ | abimaelmartell | Stops querying and showing the Recent Packages section on the Quickstart page for logged-out users by gating the query with enabled flag and conditionally rendering the section. |
...
| [#1579](https://github.com/tscircuit/tscircuit.com/pull/1579) | 🐌 Tiny | ArnavK-09 | Refactors the ShikiCodeViewer component to improve file loading handling and updates related components to use a new loading state. |
...
| [#1577](https://github.com/tscircuit/tscircuit.com/pull/1577) | 🐌 Tiny | ArnavK-09 | Removes unused components (Footer2, StaticViewSnippetHeader, ViewSnippetHeader, etc.), deletes unused pages (settings.tsx), cleans up unused dependencies (prismjs, input-otp, country-list, etc.), removes use client directives from multiple files, and cleans up commented code and unused imports. |
...
| PR # | Impact | Rating | Contributor | Description |
|------|--------|--------|-------------|-------------|
| [#12](https://github.com/tscircuit/minicssgrid/pull/12) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Fixes layout issue by ensuring at least one implicit column is created when no explicit columns are defined and children are present. |
| [#11](https://github.com/tscircuit/minicssgrid/pull/11) | 🐳 Major | ⭐⭐⭐ | imrishabh18 | Handles implicit row and column sizing in the grid layout when no explicit template is specified, ensuring proper distribution of space based on container dimensions. |
...
| [#1148](https://github.com/tscircuit/core/pull/1148) | 🐌 Tiny | imrishabh18 | Changes the error type from source_trace_not_connected to source_trace_not_connected_error in error handling and tests. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#61](https://github.com/tscircuit/circuit-json-util/pull/61) | 🐌 Tiny | Abse2001 | Enforces the use of Zod version 3.x in peer dependencies of the project. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#230](https://github.com/tscircuit/tscircuit-autorouter/pull/230) | 🐌 Tiny | Abse2001 | Adds a new JSON asset and a corresponding React component for testing high-density autorouting scenarios. |
| [#231](https://github.com/tscircuit/tscircuit-autorouter/pull/231) | 🐌 Tiny | seveibar | Add downloaded autorouting bug report fixture for fe4a172b-07ce-4cd1-a6c7-69c5c05a24c9 |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#78](https://github.com/tscircuit/jlcsearch/pull/78) | 🐌 Tiny | seveibar | Add RISC-V processor search route, documentation, and link from component overview. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#11](https://github.com/tscircuit/circuit-json-to-simple-3d/pull/11) | 🐌 Tiny | pxlpal | Updates the bun.lock file to resolve issues with the publish action failing on the main branch. |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#343](https://github.com/tscircuit/schematic-symbols/pull/343) | 🐌 Tiny | techmannih | Updates the bun-match-svg dependency from version 0.0.6 to 0.0.12 in package.json |
...
| PR # | Impact | Contributor | Description |
|------|--------|-------------|-------------|
| [#840](https://github.com/tscircuit/eval/pull/840) | 🐌 Tiny | tscircuitbot | Automated update of tscircuitcore to v0.0.631. |
...
| [#12](https://github.com/tscircuit/minicssgrid/pull/12) | 🐳 Major | ⭐⭐⭐ | Fixes layout issue by ensuring at least one implicit column is created when no explicit columns are defined and children are present. |
| [#11](https://github.com/tscircuit/minicssgrid/pull/11) | 🐳 Major | ⭐⭐⭐ | Handles implicit row and column sizing in the grid layout when no explicit template is specified, ensuring proper distribution of space based on container dimensions. |
...
| [#313](https://github.com/tscircuit/cli/pull/313) | 🐙 Minor | ⭐⭐ | Handles cancellation of interactive sessions gracefully by catching TypeErrors and exiting with a specific code. |
...
| [#1148](https://github.com/tscircuit/core/pull/1148) | 🐌 Tiny | Changes the error type from source_trace_not_connected to source_trace_not_connected_error in error handling and tests. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#128](https://github.com/tscircuit/sparkfun-boards/pull/128) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun Multiplexer Breakout board with a 74HC4051 chip, including its schematic and footprint. |
| [#125](https://github.com/tscircuit/sparkfun-boards/pull/125) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun SSOP to DIP adapter board with a complete schematic and PCB design. |
...
| [#255](https://github.com/tscircuit/circuit-json/pull/255) | 🐙 Minor | ⭐⭐ | Adds support for both AC and DC voltage sources in simulation, allowing for more versatile circuit simulations. |
| [#360](https://github.com/tscircuit/props/pull/360) | 🐙 Minor | ⭐⭐ | Adds a new VoltageSource component with properties for voltage, frequency, peak-to-peak voltage, wave shape, and phase. |
| [#1167](https://github.com/tscircuit/core/pull/1167) | 🐙 Minor | ⭐⭐ | Adds a new AC Voltage Source component with configurable properties such as voltage, frequency, and wave shape. |
...
| [#1574](https://github.com/tscircuit/tscircuit.com/pull/1574) | 🐳 Major | ⭐⭐⭐ | Optimizes file content fetching in the ImportantFilesView component to prevent multiple requests and reduce loading latency. |
...
| [#1579](https://github.com/tscircuit/tscircuit.com/pull/1579) | 🐌 Tiny | Refactors the ShikiCodeViewer component to improve file loading handling and updates related components to use a new loading state. |
...
| [#1577](https://github.com/tscircuit/tscircuit.com/pull/1577) | 🐌 Tiny | Removes unused components (Footer2, StaticViewSnippetHeader, ViewSnippetHeader, etc.), deletes unused pages (settings.tsx), cleans up unused dependencies (prismjs, input-otp, country-list, etc.), removes use client directives from multiple files, and cleans up commented code and unused imports. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#106](https://github.com/tscircuit/jscad-electronics/pull/106) | 🐳 Major | ⭐⭐⭐ | Add a React-free JSX runtime and renderer that preserves color metadata for geometries in the JSCAD modeling library. |
| [#135](https://github.com/tscircuit/sparkfun-boards/pull/135) | 🐳 Major | ⭐⭐⭐ | Introduces a new circuit board for the SparkFun Proximity Sensor Breakout (VCNL4040) with complete schematic and footprint definitions. |
| [#134](https://github.com/tscircuit/sparkfun-boards/pull/134) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun microB USB Breakout board with its schematic and footprint. |
| [#133](https://github.com/tscircuit/sparkfun-boards/pull/133) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun Qwiic Adapter circuit board with associated schematic and footprint files. |
| [#132](https://github.com/tscircuit/sparkfun-boards/pull/132) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun Triple Axis Accelerometer Breakout ADXL362 with its schematic and footprint. |
| [#131](https://github.com/tscircuit/sparkfun-boards/pull/131) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun USB Type-A Female Breakout board with associated schematic and footprint files. |
| [#129](https://github.com/tscircuit/sparkfun-boards/pull/129) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun SOT23 to DIP adapter circuit board with associated documentation and schematic. |
| [#127](https://github.com/tscircuit/sparkfun-boards/pull/127) | 🐳 Major | ⭐⭐⭐ | Adds a new SparkFun I2S Audio Breakout board with MAX98357A chip including schematic and footprint. |
...
| PR # | Impact | Description |
|------|--------|-------------|
| [#61](https://github.com/tscircuit/circuit-json-util/pull/61) | 🐌 Tiny | Enforces the use of Zod version 3.x in peer dependencies of the project. |
| [#230](https://github.com/tscircuit/tscircuit-autorouter/pull/230) | 🐌 Tiny | Adds a new JSON asset and a corresponding React component for testing high-density autorouting scenarios. |
...
| [#21](https://github.com/tscircuit/calculate-packing/pull/21) | 🐳 Major | ⭐⭐⭐ | Implements the OutlineSegmentCandidatePointSolver and IrlsSolver to optimize component packing by minimizing distances to existing components on a network. |
...
| [#6](https://github.com/tscircuit/matchpack/pull/6) | 🐙 Minor | ⭐⭐ | Adds an example circuit for the RP2040 chip, including a new page and components for visualization and debugging. |
...
| [#78](https://github.com/tscircuit/jlcsearch/pull/78) | 🐌 Tiny | Add RISC-V processor search route, documentation, and link from component overview. |
...
| [#231](https://github.com/tscircuit/tscircuit-autorouter/pull/231) | 🐌 Tiny | Add downloaded autorouting bug report fixture for fe4a172b-07ce-4cd1-a6c7-69c5c05a24c9 |
...
| [#11](https://github.com/tscircuit/circuit-json-to-simple-3d/pull/11) | 🐌 Tiny | Updates the bun.lock file to resolve issues with the publish action failing on the main branch. |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#363](https://github.com/tscircuit/footprinter/pull/363) | 🐙 Minor | ⭐⭐ | Fixes origin translation for silkscreen elements, ensuring all elements are shifted correctly, not just pads. |
...
| PR # | Impact | Description |
|------|--------|-------------|
| [#343](https://github.com/tscircuit/schematic-symbols/pull/343) | 🐌 Tiny | Updates the bun-match-svg dependency from version 0.0.6 to 0.0.12 in package.json |
...
| PRs # | Impact | Rating | Description |
|------|--------|--------|-------------|
| [#1588](https://github.com/tscircuit/tscircuit.com/pull/1588) | 🐳 Major | ⭐⭐⭐ | Stops querying and showing the Recent Packages section on the Quickstart page for logged-out users by gating the query with enabled flag and conditionally rendering the section. |
...
| [#1013](https://github.com/tscircuit/runframe/pull/1013) | 🐳 Major | ⭐⭐⭐ | Adds an optional isLoadingFiles prop to RunFrame to show a loading spinner when files are being fetched, improving user feedback during file loading. |
...
| PR # | Impact | Description |
|------|--------|-------------|
| [#840](https://github.com/tscircuit/eval/pull/840) | 🐌 Tiny | Automated update of tscircuitcore to v0.0.631. |
