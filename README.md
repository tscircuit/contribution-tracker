...
| [#646](https://github.com/tscircuit/tscircuit/pull/646) | 🐙 Minor | Add `@tscircuit/eval` exports, install all dependent `tscircuit` modules, and ensure versions match with the core. | ✅ |
| [#32](https://github.com/tscircuit/circuit-json-util/pull/32) | 🐙 Minor | Improve the acceptance of input circuit JSON to reduce downstream casting | ✅ |
| [#228](https://github.com/tscircuit/props/pull/228) | 🐙 Minor | Add support for `pinCompatibleVariants` for `chip` | ✅ |
| [#818](https://github.com/tscircuit/core/pull/818) | 🐙 Minor | Update schematic symbols to fix boxresistor issue | ✅ |
