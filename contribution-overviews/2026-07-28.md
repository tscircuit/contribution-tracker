...
|-------------|---------|---------|---------|-------|-----|
| [seveibar](#seveibar) | 89 | 63 | 50 | 496 | 👑👑👑 |
...
| [#2999](https://github.com/tscircuit/core/pull/2999) | 🐳 Major | ⭐⭐⭐ | seveibar | Emit resolved DDR routing constraints including bus maxLengthSkew, traceWidth, allowedLayers, and differential-pair traceGap and maxUncoupledLength through existing adapters, while maintaining existing design compatibility. |
...
| [#2994](https://github.com/tscircuit/core/pull/2994) | 🐙 Minor | ⭐⭐ | seveibar | Disables legacy autorouters by default, requiring explicit opt-in for legacy behavior and migrating tests to the default autorouter. |
...
| [#2999](https://github.com/tscircuit/core/pull/2999) | 🐳 Major | ⭐⭐⭐ | Emit resolved DDR routing constraints including bus maxLengthSkew, traceWidth, allowedLayers, and differential-pair traceGap and maxUncoupledLength through existing adapters, while maintaining existing design compatibility. |
...
| [#2994](https://github.com/tscircuit/core/pull/2994) | 🐙 Minor | ⭐⭐ | Disables legacy autorouters by default, requiring explicit opt-in for legacy behavior and migrating tests to the default autorouter. |
