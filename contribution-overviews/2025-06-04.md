...
```mermaid
pie
    "tscircuit/tscircuit.com" : 150
    "tscircuit/core" : 80
    "tscircuit/circuit-to-svg" : 46
    "tscircuit/bpc-graph" : 46
    "tscircuit/sparkfun-boards" : 44
    "tscircuit/props" : 43
...
| [#886](https://github.com/tscircuit/core/pull/886) | 🐙 Minor | techmannih | Fixes the display of resistance units in the potentiometer component to correctly show the maximum resistance value with the appropriate unit (Ω). |
...
| [#236](https://github.com/tscircuit/circuit-to-svg/pull/236) | 🐌 Tiny | Abse2001 | Updates the dependency '@tscircuit/core' from a specific commit URL to a stable version '0.0.436'. |
...
| [#1236](https://github.com/tscircuit/tscircuit.com/pull/1236) | 🐌 Tiny | techmannih | Updates the version of the @tscircuit/footprinter dependency from ^0.0.169 to ^0.0.176 in package.json. |
...
| [#737](https://github.com/tscircuit/runframe/pull/737) | 🐌 Tiny | seveibar | ![image](https://github.com/user-attachments/assets/924ef875-920e-4b07-bac3-ab345d131d4c)

## Summary
- update `circuit-json` to latest
- collect warnings from `circuitJson`
- show circuit-json warnings in orange below errors |
| [#736](https://github.com/tscircuit/runframe/pull/736) | 🐌 Tiny | seveibar | Displays a message indicating 'No errors or warnings!' in the ErrorTabContent when no errors exist, and ensures the ErrorTabContent is visible once the circuit JSON is ready. |
...
| [#218](https://github.com/tscircuit/circuit-json/pull/218) | 🐌 Tiny | seveibar | Adds a `warning_type` property to PCB and schematic manual edit warnings, enhancing the clarity of warning messages. |
...
| [#270](https://github.com/tscircuit/props/pull/270) | 🐌 Tiny | seveibar | ## Summary
- add new `solderjumper` component extending `jumper`
- expose `solderjumper` from library
- document `SolderJumperProps`
- include tests for `solderjumper`

## Testing
- `bun test`
- `npm run generate:component-types`
- `npm run generate:readme-docs`
- `npm run format` |
...
| [#267](https://github.com/tscircuit/props/pull/267) | 🐌 Tiny | seveibar | ## Summary
- remove the unused `titleAnchorPosition` prop
...
| [#304](https://github.com/tscircuit/schematic-symbols/pull/304) | 🐌 Tiny | imrishabh18 | Adds pin aliases 'pos' and 'neg' to capacitor symbols for better clarity in schematic representation. |
| [#301](https://github.com/tscircuit/schematic-symbols/pull/301) | 🐌 Tiny | imrishabh18 | Fixes the labeling of positive and negative terminals for polarized capacitors in schematic symbols. |
...
| [#224](https://github.com/tscircuit/cli/pull/224) | 🐌 Tiny | ShiboSoftwareDev | Updates the tscircuit package version from 0.0.485 to 0.0.491 and adds a new dependency on @tscircuit/math-utils to address existing issues, although the double board issue remains unresolved. |
| [#223](https://github.com/tscircuit/cli/pull/223) | 🐌 Tiny | ShiboSoftwareDev | Updates the versions of dependencies in package.json, specifically '@tscircuit/runframe' to '^0.0.566' and 'bun-match-svg' to '^0.0.11'. |
| [#221](https://github.com/tscircuit/cli/pull/221) | 🐌 Tiny | ShiboSoftwareDev | Updates the circuit-to-svg dependency to version 0.0.152, which likely includes improvements for generating more accurate SVG snapshots of circuit designs. |
| [#220](https://github.com/tscircuit/cli/pull/220) | 🐌 Tiny | ShiboSoftwareDev | Fixes the snapshot command to correctly create SVG snapshots and updates related tests to ensure proper functionality. |
...
| [#69](https://github.com/tscircuit/docs/pull/69) | 🐌 Tiny | techmannih | Fixes image overflow issues on mobile devices by ensuring images within <img> tags are responsive and do not exceed their container's width. |
...
| [#2](https://github.com/tscircuit/sparkfun-boards/pull/2) | 🐳 Major | ShiboSoftwareDev | I'm not sure why there are two boards, I believe this is an old and already fixed eval issue |
...
| [#24](https://github.com/tscircuit/schematic-match-adapt/pull/24) | 🐳 Major | ## Summary
- add `defaultLeftRightChipWidth` to `CircuitBuilder`
- apply new width logic in `ChipBuilder`
- update snapshots
- add test for new width rule
...
| [#303](https://github.com/tscircuit/schematic-symbols/pull/303) | 🐙 Minor | Marks `capacitor_polarized_*` ports with positive/negative aliases for better clarity in schematic representations. |
...
| [#218](https://github.com/tscircuit/circuit-json/pull/218) | 🐌 Tiny | Adds a `warning_type` property to PCB and schematic manual edit warnings, enhancing the clarity of warning messages. |
...
| [#270](https://github.com/tscircuit/props/pull/270) | 🐌 Tiny | ## Summary
- add new `solderjumper` component extending `jumper`
- expose `solderjumper` from library
- document `SolderJumperProps`
- include tests for `solderjumper`
...
| [#267](https://github.com/tscircuit/props/pull/267) | 🐌 Tiny | ## Summary
- remove the unused `titleAnchorPosition` prop
- regenerate component docs
...
| [#737](https://github.com/tscircuit/runframe/pull/737) | 🐌 Tiny | ![image](https://github.com/user-attachments/assets/924ef875-920e-4b07-bac3-ab345d131d4c)

## Summary
- update `circuit-json` to latest
- collect warnings from `circuitJson`
- show circuit-json warnings in orange below errors |
| [#736](https://github.com/tscircuit/runframe/pull/736) | 🐌 Tiny | Displays a message indicating 'No errors or warnings!' in the ErrorTabContent when no errors exist, and ensures the ErrorTabContent is visible once the circuit JSON is ready. |
...
| [#236](https://github.com/tscircuit/circuit-to-svg/pull/236) | 🐌 Tiny | Updates the dependency '@tscircuit/core' from a specific commit URL to a stable version '0.0.436'. |
...
![image](https://github.com/user-attachments/assets/70f32353-4c6a-4ccd-81e8-ebccc03ec867) |
| [#2](https://github.com/tscircuit/sparkfun-boards/pull/2) | 🐳 Major | I'm not sure why there are two boards, I believe this is an old and already fixed eval issue |
...
| [#224](https://github.com/tscircuit/cli/pull/224) | 🐌 Tiny | Updates the tscircuit package version from 0.0.485 to 0.0.491 and adds a new dependency on @tscircuit/math-utils to address existing issues, although the double board issue remains unresolved. |
| [#223](https://github.com/tscircuit/cli/pull/223) | 🐌 Tiny | Updates the versions of dependencies in package.json, specifically '@tscircuit/runframe' to '^0.0.566' and 'bun-match-svg' to '^0.0.11'. |
| [#221](https://github.com/tscircuit/cli/pull/221) | 🐌 Tiny | Updates the circuit-to-svg dependency to version 0.0.152, which likely includes improvements for generating more accurate SVG snapshots of circuit designs. |
| [#220](https://github.com/tscircuit/cli/pull/220) | 🐌 Tiny | Fixes the snapshot command to correctly create SVG snapshots and updates related tests to ensure proper functionality. |
...
| [#304](https://github.com/tscircuit/schematic-symbols/pull/304) | 🐌 Tiny | Adds pin aliases 'pos' and 'neg' to capacitor symbols for better clarity in schematic representation. |
| [#301](https://github.com/tscircuit/schematic-symbols/pull/301) | 🐌 Tiny | Fixes the labeling of positive and negative terminals for polarized capacitors in schematic symbols. |
...
| [#886](https://github.com/tscircuit/core/pull/886) | 🐙 Minor | Fixes the display of resistance units in the potentiometer component to correctly show the maximum resistance value with the appropriate unit (Ω). |
...
| [#1236](https://github.com/tscircuit/tscircuit.com/pull/1236) | 🐌 Tiny | Updates the version of the @tscircuit/footprinter dependency from ^0.0.169 to ^0.0.176 in package.json. |
...
| [#69](https://github.com/tscircuit/docs/pull/69) | 🐌 Tiny | Fixes image overflow issues on mobile devices by ensuring images within <img> tags are responsive and do not exceed their container's width. |
